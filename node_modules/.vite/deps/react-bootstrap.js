...
import {
  ...
  require_warning,
  useCol
} from "./chunk-5747LWOW.js";
import {
  createWithBsPrefix,
  require_prop_types
} from "./chunk-KF4OTPCX.js";
import {
  DEFAULT_BREAKPOINTS,
...
function $704cf1d3b684cc5c$export$619500959fc48b26(defaultId) {
  ...
  return (0, import_react18.useMemo)(() => defaultId || `react-aria${ctx.prefix}-${++ctx.current}`, [
    defaultId
  ]);
}
...
Container.defaultProps = defaultProps12;
...
Image.defaultProps = defaultProps13;
...
FigureImage.defaultProps = defaultProps14;
...
function useTransition({
  ...
  const isInitialRef = (0, import_react32.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react32.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react32.cloneElement)(children, {
    ref: combinedRef
  });
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react33.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react33.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react33.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react33.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react33.useState)(!show);
  const lastFocusRef = (0, import_react33.useRef)(null);
  (0, import_react33.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react33.useRef)();
  const removeKeydownListenerRef = (0, import_react33.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime41.jsx)("div", Object.assign({}, dialogProps, {
    children: React46.cloneElement(children, {
      role: "document"
    })
  }));
...
var AbstractModalHeader = React49.forwardRef(({
  closeLabel,
  closeVariant,
  closeButton,
  onHide,
  ...
  const context6 = (0, import_react34.useContext)(ModalContext_default);
...
AbstractModalHeader.defaultProps = defaultProps15;
...
var Modal2 = React51.forwardRef(({
  ...
  const renderBackdrop = (0, import_react35.useCallback)((backdropProps) => (0, import_jsx_runtime48.jsx)("div", {
    ...backdropProps,
...
Modal2.defaultProps = defaultProps17;
...
var NavLink = React52.forwardRef(({
  ...
  return (0, import_jsx_runtime49.jsx)(Component2, {
    ...
    ...navItemProps,
    ref,
    className: (0, import_classnames31.default)(className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")
  });
});
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react40.useMemo)(function() {
...
var Offcanvas = React59.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react41.useCallback)((backdropProps) => (0, import_jsx_runtime56.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React60.forwardRef((props, ref) => {
...
var Navbar = React61.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand,
    variant,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime68.jsxs)(import_jsx_runtime67.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react48.cloneElement)(children, triggerProps), (0, import_jsx_runtime66.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime88.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
